...
public class ChartView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // Calculation minimum number of labels which should fit view`s width.
    ...
    private void prepareChartIfReady() {
        ...
        if (xSize < 2 * xLabelsMinCount) {
            ...
            // Current level can be calculated as a maximum power of 2 is less or equal to
        ...
        chartMatrix.postTranslate(left, getMeasuredHeight());
